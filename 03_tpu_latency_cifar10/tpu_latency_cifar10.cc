...
#define IMAGE_DOG "/home/byeongyun/EAI_TfLite/03_tpu_latency_cifar10/image/sample.jpg"
#define IMAGE_BIRD "/home/byeongyun/EAI_TfLite/03_tpu_latency_cifar10/image/sample2.jpg"
#define CIFAR_10_LABELS "/home/byeongyun/EAI_TfLite/03_tpu_latency_cifar10/image/cifar10_label.txt"
...
void readImageCV(string filename, vector<cv::Mat>& input){
  ...
  cv::resize(cvimg, cvimg, cv::Size(128, 128)); 
...
int main(int argc, char* argv[]) {
  ...
  readImageCV(IMAGE_DOG, inputs);
  readImageCV(IMAGE_BIRD, inputs);
